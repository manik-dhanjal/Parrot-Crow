        ...
        <div className="f-sec2">
            ...
            <div className="f-sec3 container">
                ...
                <div className="contact-form">
                    <form action="https://parrotcrow.us19.list-manage.com/subscribe/post?u=2e3981b47ed4e645aeb225270&amp;id=2e2a2f6f7f"  method="post"    className="mailing-form" name="mc-embedded-subscribe-form" target="_blank"    >
                        <div className="group-input">
                            <input placeholder="E-mail address"  type="email" required="required" name="EMAIL" className="email"/>
                            <button  type="submit"  className="f-subscribe" >
                                Subscribe
                            </button>
                        </div>
                    </form>
